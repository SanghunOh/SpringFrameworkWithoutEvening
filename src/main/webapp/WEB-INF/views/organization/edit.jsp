                            ...
                            <!-- /.row (nested) -->
                                    <form role="form" method="GET" action="<c:url value='/organization/read' />">
										<div class="form-group">
										    <label for="disabledSelect">ORGANIZATION SEQ Disabled input </label>
                                        ...
                                        <div class="form-group">
										    <label for="disabledSelect">PARENT ORGANIZATION SEQ Disabled input </label>
										    <input class="form-control" type="text" name="PARENT_ORGANIZATION_SEQ" value="" readonly>
