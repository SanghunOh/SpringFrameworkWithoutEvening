                            ...
                            <!-- /.row (nested) -->
                                    <form role="form" method="GET" action="<c:url value='/organization/edit' />">
	                                    <div class="form-group">
											<label>ORGANIZATION SEQ Static Control</label>
											<p class="form-control-static">${resultMap.ORGANIZATION_SEQ}</p>
	                                    </div>
	                                    <div class="form-group">
											<label>ORGANIZATION NAME Static Control</label>
	                                    ...
	                                    <div class="form-group">
											<label>ORDER NUMBER Static Control</label>
											<p class="form-control-static">${resultMap.ORDER_NUMBER}</p>
	                                    </div>
	                                    <div class="form-group">
											<label>PARENT ORGANIZATION SEQ Static Control</label>
