                            ...
                            <!-- /.row (nested) -->
                                    <form role="form" method="POST" action="<c:url value='/commonCode/read' />">
										<div class="form-group">
										    <label>COMMON CODE ID input </label>
										    <input class="form-control" type="text" name="COMMON_CODE_ID" value="">
										</div>
                                        <div class="form-group">
                                            <label>CODE NAME Text Input </label>
                                            <input class="form-control" type="text" name="CODE_NAME">
                                        </div>
                                        <div class="form-group">
										    <label>ORDER NUMBER input </label>
										    <input class="form-control" type="text" name="ORDER_NUMBER" value="" placeholder="1">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
										    <label for="disabledSelect">PARENT COMMON CODE ID Disabled input </label>
										    <input class="form-control" type="text" name="PARENT_COMMON_CODE_ID" value="" readonly>
